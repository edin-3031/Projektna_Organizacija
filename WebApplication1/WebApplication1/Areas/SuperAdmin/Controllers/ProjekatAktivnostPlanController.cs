...
namespace WebApplication1.Areas.SuperAdmin.Controllers
{
    public class ProjekatAktivnostPlanController : Controller
    {
        ...
        [Area("SuperAdmin")]
        public IActionResult UrediSnimi(int id, int u, int o, int r, DateTime OD, DateTime DO, string jedinicaMjere, float kolicina, string naziv, int proj_plan_id, int sifra)
        {
